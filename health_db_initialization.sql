...
('administrator', '$2a$12$GqS4yfRrKjOZ.Sts3Ydd7.ngD.XUO.gX4xvfYXVhGMiX7/j7XGNrm', 'Admin User', 'admin@hicms.com', '9876543210', '1980-08-15', '123 Admin Office Street, New York', 'ADMIN', 'ACTIVE', NULL, NULL, NULL, NOW());

-- APPROVER USERS (2)
INSERT INTO users (username, password, full_name, email, phone_number, date_of_birth, address, role, account_status, bank_account_number, ifsc_code, bank_name, created_at) VALUES
('approver_1', '$2a$12$edUxPIHUfImLJXFEZoiWiuiAWAje397lss7imcK/uqfsh9Fx5jUIC', 'John Approver', 'approver1@hicms.com', '9876543211', '1975-05-20', '456 Approver Lane, Boston', 'APPROVER', 'ACTIVE', NULL, NULL, NULL, NOW()),
('approver_2', '$2a$12$edUxPIHUfImLJXFEZoiWiuiAWAje397lss7imcK/uqfsh9Fx5jUIC', 'Sarah Approver', 'approver2@hicms.com', '9876543212', '1978-03-10', '789 Reviewer Road, Chicago', 'APPROVER', 'ACTIVE', NULL, NULL, NULL, NOW());
...
('draven27', '$2a$12$05qSDPjY7feEIVFPB4Alx.c7WMgid/ECWEvR2pBRBo3QlVssGpz2i', 'Draven Sam Robert', 'dsr@email.com', '5555444333', '1985-05-12', '500 River Street, Hyderabad', 'POLICYHOLDER', 'ACTIVE', '5678901234567890', 'NDSE0000005', 'NDSE Bank', NOW()),
('angel31', '$2a$12$05qSDPjY7feEIVFPB4Alx.c7WMgid/ECWEvR2pBRBo3QlVssGpz2i', 'Angel', 'angel@email.com', '4444333222', '1993-06-18', '600 Valley Road, Chennai', 'POLICYHOLDER', 'ACTIVE', '6789012345678901', 'IDIB0000006', 'IDBI Bank', NOW()),
('gowtham40', '$2a$12$05qSDPjY7feEIVFPB4Alx.c7WMgid/ECWEvR2pBRBo3QlVssGpz2i', 'Gowtham', 'gowtham@email.com', '3333222111', '1987-07-22', '700 Mountain Street, Kochi', 'POLICYHOLDER', 'ACTIVE', '7890123456789012', 'BOBI0000007', 'BoB Bank', NOW()),
('sivaranjeni25', '$2a$12$05qSDPjY7feEIVFPB4Alx.c7WMgid/ECWEvR2pBRBo3QlVssGpz2i', 'Sivaranjeni', 'siva@email.com', '2222111000', '1989-08-28', '800 Forest Lane, Jaipur', 'POLICYHOLDER', 'ACTIVE', '8901234567890123', 'KKBK0000008', 'Kotak Bank', NOW()),
('banu50', '$2a$12$05qSDPjY7feEIVFPB4Alx.c7WMgid/ECWEvR2pBRBo3QlVssGpz2i', 'Hajira Banu', 'hajiri@email.com', '1111000999', '1991-09-05', '900 Desert Road, Surat', 'POLICYHOLDER', 'INACTIVE', '9012345678901234', 'AUBL0000009', 'Aurora Bank', NOW()),
